      ...
      <div className="flex gap-4">
        ...
        {image && (
          <Link
            ...
            onClick={close}
            prefetch="intent"
            className="shrink-0 w-24 h-24 bg-primary/5 rounded overflow-hidden"
          >
            <Image
            ...
            <div className="flex items-center border border-primary/15 rounded">
              ...
              >
                <button
                  ...
                  className="w-9 h-9 flex items-center justify-center text-primary bg-transparent border-none cursor-pointer hover:bg-primary/5 transition-colors duration-fast disabled:opacity-30 disabled:cursor-not-allowed text-sm"
                >
                  &minus;
                </button>
              </CartLineUpdateButton>
              ...
              <span
                className="w-9 h-9 flex items-center justify-center text-sm font-body font-medium text-primary border-x border-primary/15 select-none"
