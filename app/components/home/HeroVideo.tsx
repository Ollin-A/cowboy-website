  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-body text-lg md:text-xl text-white/80 mb-8 max-w-xl mx-auto">
          {subline}
        </p>
        <Link
          to={ctaLink}
          prefetch="intent"
          className="inline-flex items-center justify-center px-10 py-4 border-2 border-white text-white font-body font-medium text-sm tracking-widest uppercase no-underline transition-all duration-200 hover:bg-white hover:text-primary hover:no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2"
        >
          {ctaText}
        </Link>
      </div>
