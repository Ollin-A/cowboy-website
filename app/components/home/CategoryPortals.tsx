  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className={[
            'flex items-center justify-center w-12 h-12 rounded-full text-white text-xl leading-none transition-opacity duration-fast',
            'md:opacity-0 md:group-hover:opacity-100',
          ].join(' ')}
          style={{border: '0.5px solid rgba(255,255,255,0.6)'}}
          aria-hidden="true"
        >
          +
        </span>
      ...
      >
        {data.subcategories.map((sub) => {
          const isShopAll = sub.label.toLowerCase().startsWith('shop all');
          return (
            <Link
              key={sub.href}
              to={sub.href}
              ...
              className={
                isShopAll
                  ? 'text-white/70 font-body text-xs tracking-wide opacity-0 underline underline-offset-4 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 mt-2'
                  : 'text-white font-body text-sm md:text-base tracking-wide uppercase opacity-0 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2'
              }
